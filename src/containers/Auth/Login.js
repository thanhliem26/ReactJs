      ...
      <div className="login-background">
        <div className="login-container">
          <div className="login-content row ">
            <div className="col-12 text-login">Login haha</div>
              ...
              <div className="form_password">
                ...
                {!this.state.showPass && (
                  <i
                    ...
                    onClick={() => this.handleShowPass(true)}
                  ></i>
                )}
                {this.state.showPass && (
                  <i
                    className="fas fa-eye-slash"
                    onClick={() => this.handleShowPass(false)}
                  ></i>
                )}
              </div>
            </div>
            <div className="message_err">{this.state.errMessage}</div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    userLoginSuccess: (userInfor) =>
      dispatch(actions.userLoginSucces(userInfor)),
  };
};
